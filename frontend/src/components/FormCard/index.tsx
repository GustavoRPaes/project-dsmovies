        ...
        <div className="grmovie-form-container">
            ...
            <div className="grmovie-card-bottom-container">
                ...
                <form className="grmovie-form" onSubmit={handleSubmit}>
                    ...
                    <div className="grmovie-form-btn-container">
                        <button type="submit" className="btn btn-primary grmovie-btn">Salvar</button>
                    </div>
                </form >
                <Link to="/">
                    <button className="btn btn-primary grmovie-btn mt-3">Cancelar</button>
                </Link>
            </div >
        </div >
